...
export const DAY_SERIES = [
  ...
  },
  {
    ...
    above: (k) => `În câte zile a strâns peste ${cantitate(k, 'alună', 'alune')}?`,
    steps: [2, 5],
  },
  {
    id: 'vizitatori',
  ...
  },
  {
    ...
    diff: (a, b) => `Cu câte înghețate mai mult ${a} decât ${b}?`,
...
export const PAIR_SERIES = [
  ...
  },
  {
    ...
    dayMore: (a, b, k) => `În ce zi a sărit ${a} cu ${k} mai mult decât ${b}?`,
