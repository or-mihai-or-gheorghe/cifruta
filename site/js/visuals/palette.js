...
export const C = {
  ...
  redLight: 'var(--v-red-light, #F9B4AE)',
  yellowLight: 'var(--v-yellow-light, #FFE99E)',
  tealDark: 'var(--v-teal-dark, #2BA59C)',
  tealLight: 'var(--v-teal-light, #BFEEE9)',
  purpleDark: 'var(--v-purple-dark, #7453CF)',
  pinkLight: 'var(--v-pink-light, #FDE1E8)',
  brownDark: 'var(--v-brown-dark, #7F4F2A)',
  grayDark: 'var(--v-gray-dark, #8F899C)',
  grassLight: 'var(--v-grass-light, #C4EBB2)',
  coal: 'var(--v-coal, #4B4453)',
  coalLight: 'var(--v-coal-light, #6E6778)',
  space: 'var(--v-space, #2B2552)',
  medalBronz: 'var(--v-medal-bronz, #D9894F)',
  medalBronzDark: 'var(--v-medal-bronz-dark, #9E5A2B)',
  medalBronzLight: 'var(--v-medal-bronz-light, #F4C7A1)',
  medalArgint: 'var(--v-medal-argint, #CFD5DE)',
  medalArgintDark: 'var(--v-medal-argint-dark, #8B94A4)',
  medalArgintLight: 'var(--v-medal-argint-light, #F7F9FC)',
  medalAur: 'var(--v-medal-aur, #F5C542)',
  medalAurDark: 'var(--v-medal-aur-dark, #C68D0E)',
  medalAurLight: 'var(--v-medal-aur-light, #FFEAA6)',
  series1: 'var(--v-series-1, #2A78D6)',
  series2: 'var(--v-series-2, #EB6834)',
  series3: 'var(--v-series-3, #1BAF7A)',
  series4: 'var(--v-series-4, #4A3AA7)',
  s: 'var(--v-s, #2E9E44)',
  z: 'var(--v-z, #E03131)',
  u: 'var(--v-u, #1C7ED6)',
};
