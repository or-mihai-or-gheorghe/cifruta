...
export default {
  ...
  topics: [
    ...
    },
    {
      ...
      concepts: [
        'mat.nr1000.formare',
        'mat.nr1000.citire-scriere',
        'mat.nr1000.comparare',
        'mat.nr1000.ordonare',
        'mat.nr1000.siruri',
        'mat.nr1000.rotunjire',
        'mat.op1000.fara-trecere',
        'mat.op1000.cu-trecere',
        'mat.op.comparare-expresii',
      ],
      levels: [
        {
          id: 'usor',
          warmup: ['op-sute', 'cmp-sute'],
          mix: [
            { kind: 'op-sute', weight: 3 },
            { kind: 'nr-extins', weight: 2.5 },
            { kind: 'cmp-sute', weight: 2 },
            { kind: 'nr-numaratoare', weight: 2 },
            { kind: 'sort-3-sute', weight: 1.5 },
            { kind: 'nr-litere', weight: 1 },
          ],
          stars: [28, 68, 160],
        },
        {
          ...
          mix: [
            { kind: 'add-1000-fara', weight: 2.5 },
            { kind: 'sub-1000-fara', weight: 2 },
            { kind: 'op-zeci-sute', weight: 2 },
            { kind: 'cmp-1000', weight: 1.5 },
            { kind: 'sort-4-1000', weight: 1.5 },
            { kind: 'sir-1000', weight: 1.5 },
            { kind: 'rotunjire-sute', weight: 1 },
            { kind: 'nr-extins', weight: 1 },
            { kind: 'nr-numaratoare', weight: 0.5 },
            { kind: 'op-sute', weight: 0.5 },
            { kind: 'cmp-sute', weight: 0.5 },
          ],
          stars: [31, 82, 207],
        },
        {
          ...
          mix: [
            ...
            { kind: 'add-1000-cu', weight: 2 },
            { kind: 'sub-1000-cu', weight: 1.5 },
            { kind: 'sort-4-1000-dir', weight: 1.5 },
            { kind: 'add-1000-fara', weight: 1.5 },
            { kind: 'sub-1000-fara', weight: 1 },
            { kind: 'rotunjire-sute', weight: 0.5 },
            { kind: 'sir-1000', weight: 0.5 },
            { kind: 'cmp-1000', weight: 0.5 },
            { kind: 'op-zeci-sute', weight: 0.5 },
          ],
          stars: [35, 90, 253],
        },
      ],
