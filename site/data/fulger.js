...
export default {
  ...
  topics: [
    ...
    {
      id: 'harti-arbori',
      title: 'Hărți și arbori',
      short: 'Hărți și arbori',
      text: 'Hărți de linii, drumuri cu minute, rețele de prieteni, turnee și arbori: numeri stații, găsești schimbul, aduni minute și alune.',
      icon: 'harta',
      grade: 2,
      concepts: ['mat.geo.harta-linii', 'mat.mas.durata', 'mat.pb.o-operatie', 'mat.nr100.comparare', 'mat.log.retele', 'mat.log.arbori', 'mat.op.necunoscut', 'mat.log.clasificare'],
      levels: [
        {
          id: 'usor',
          warmup: ['linie-statii', 'prieteni'],
          mix: [
            { kind: 'linie-statii', weight: 3 },
            { kind: 'prieteni', weight: 3 },
            { kind: 'linie-care', weight: 2 },
            { kind: 'veverita-drum', weight: 2 },
            { kind: 'arbore-alegeri', weight: 1 },
          ],
          stars: [18, 48, 120],
        },
        {
          id: 'intermediar',
          warmup: ['linie-care', 'veverita-drum'],
          mix: [
            { kind: 'linie-schimb', weight: 2 },
            { kind: 'drum-minute', weight: 2 },
            { kind: 'linie-ordine', weight: 2 },
            { kind: 'prieteni-comun', weight: 2 },
            { kind: 'turneu', weight: 2 },
            { kind: 'arbore-sume', weight: 2 },
            { kind: 'arbore-clasificare', weight: 1.5 },
            { kind: 'linie-care', weight: 1 },
            { kind: 'veverita-drum', weight: 1 },
            { kind: 'arbore-alegeri', weight: 0.5 },
            { kind: 'prieteni', weight: 0.5 },
          ],
          stars: [24, 66, 175],
        },
        {
          id: 'avansat',
          warmup: ['drum-minute', 'arbore-sume'],
          mix: [
            { kind: 'drum-scurt', weight: 2.5 },
            { kind: 'drum-compara', weight: 2 },
            { kind: 'veverita-bogat', weight: 2 },
            { kind: 'arbore-sume-3', weight: 2 },
            { kind: 'turneu', weight: 1.5 },
            { kind: 'arbore-clasificare', weight: 1.5 },
            { kind: 'prieteni-comun', weight: 1 },
            { kind: 'drum-minute', weight: 0.5 },
            { kind: 'arbore-sume', weight: 0.5 },
          ],
          stars: [26, 67, 200],
        },
      ],
