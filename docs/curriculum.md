...
<!-- acoperire:start -->
T1 „Amintiri din vacanță” · T2 „La piață cu bunica” · T3 „Călătorie în spațiu” · T4 „O zi la fermă” · T5 „Lista de cumpărături”.
Numărul este al exercițiului în test. Tabelul se generează din etichetele testelor cu `npm run acoperire`;
nu îl edita de mână.

| Concept | T1 | T2 | T3 | T4 | T5 |
|-|-|-|-|-|-|
...
| `mat.nr1000.formare` (II) | — | — | — | — | 1 |
| `mat.nr1000.citire-scriere` (II) | — | — | — | — | 2 |
| `mat.nr1000.comparare` (II) | — | — | — | — | 3, 8, 10 |
| `mat.nr1000.ordonare` (II) | — | — | — | — | 8 |
| `mat.nr1000.rotunjire` (II) | — | — | — | — | 5 |
| `mat.nr1000.axa` (II) | — | — | — | — | 5 |
| `mat.nr1000.conditii` (II) | — | — | — | — | 3 |
| `mat.nr1000.valoare-pozitionala` (II) | — | — | — | — | 1 |
| `mat.op.fara-trecere` | 4, 8, 10 | — | — | — | — |
| `mat.op.cu-trecere` | — | 3, 5, 7, 9 | 9 | 5, 8 | 9 |
